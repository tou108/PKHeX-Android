...
public static class GenerateMethodJ
{
    extension<T>(T enc) where T : IEncounterSlot4
    {
        ...
        public uint SetRandomJ(PK4 pk, PersonalInfo4 pi, in EncounterCriteria criteria, uint seed)
        {
            var gr = pi.Gender;
            var id32 = pk.ID32;
        ...
        public bool SetFromIVsJ(PK4 pk, PersonalInfo4 pi, in EncounterCriteria criteria, out uint origin)
        {
            var gr = pi.Gender;
            var id32 = pk.ID32;
